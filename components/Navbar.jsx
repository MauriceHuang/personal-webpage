      ...
      <nav className="fixed z-20 bg-white w-full">
        <div className="w-full">
          <div className="flex items-center h-20 w-full">
            ...
            {/* completed the destop part */}
            {/* code for mobile screen start */}
            <div className="mr-14 flex md:hidden">
              {/* onclick is an event which triggered than only athe div is open */}
              <button
        ...
        {/* small size: moobile div start */}
        {/* these are transition properties for smooth transition b/w the tags */}
        <Transition
          show={isOpen}
        ...
        >
          {(ref) => (
            <div className="md:hidden" id="mobile-menu">
              <div
                ref={ref}
                className="bg-white max-4 mr-20 pt-4 pb-4 space-y-1"
              >
                <Link
                  href="/home"
                  activeClass="home"
